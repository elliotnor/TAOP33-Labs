...
@constraint(COVER, diag_one[k in 0:6], sum(x[i+k,i] for i in 1:8-k) <= 1)
@constraint(COVER, diag_two[k in 1:6], sum(x[i,i+k] for i in 1:8-k) <= 1)
@constraint(COVER, diag_three[k in 1:6], sum(x[i,9-k-i] for i in 1:8-k) <= 1)
@constraint(COVER, diag_four[k in 0:6], sum(x[i+k,9-i] for i in 1:8-k) <= 1)
#-------------------------------------------------------------------------------
